...
# This is meant to be a more organized version of everythingCRMS
import pandas as pd
import numpy as np
import csv
...
def load_data():
    ...
    soil_properties = pd.read_csv(r"D:\Etienne\summer2022_CRMS\CRMS_Soil_Properties5_31_2022\CRMS_Soil_Properties.csv", encoding='unicode escape')
    ...
    monthly_hydro = pd.read_csv(r"D:\Etienne\summer2022_CRMS\CRMS_Discrete_Hydrographic5_31_2022\CRMS_Discrete_Hydrographic.csv", encoding='unicode escape')
    marsh_vegetation = pd.read_csv(r"D:\Etienne\summer2022_CRMS\CRMS_Marsh_Vegetation5_31_2022\CRMS_Marsh_Vegetation.csv", encoding='unicode escape')
    # forest_vegetation = pd.read_csv(r"C:\Users\etachen\Documents\PyCharmProjs\datasetsCRMS\main\data\CRMS_Forest_Vegetation.csv", encoding='unicode escape')
    accretion = pd.read_csv(r"D:\Etienne\summer2022_CRMS\CRMS_Accretion\CRMS_Accretion.csv", encoding='unicode escape')
    # biomass = pd.read_csv(r"C:\Users\etachen\Documents\PyCharmProjs\datasetsCRMS\main\data\CRMS_Biomass.csv", encoding='unicode escape')
    surface_elevation = pd.read_csv(r"D:\Etienne\summer2022_CRMS\CRMS_Surface_Elevation5_31_2022\CRMS_Surface_Elevation.csv", encoding='unicode escape')
